    ...
    return(
        <>
                ...
                <ul className="nav flex-column MapNavbar-navArea--listZone">
                    ...
                    <li className="nav-item MapNavbar-navArea--buttonzone">
                        <ul style={{listStyle:'none', padding:'0px'}}>
                            <li id='goMypagebtn'>
                                <a className="nav-link" href="/mypage" role='button'><img src={process.env.PUBLIC_URL+"/img/mypagebtnImg.png"}/></a>
                                <p>마이페이지</p>
                            </li>
                            <li onClick={(e)=>{showMyPlace(e)}} id='showPlacebtn'>
            ...
            <button id='btnSearchListOpen'>
                <BsChevronDoubleRight style={{color:'gray', marginLeft:'-4px'}}/>
            </button>
        </>
    )
}
