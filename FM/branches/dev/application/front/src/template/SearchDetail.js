                                            ...
                                            <div id="outImgzone">
                                                {(()=>{
                                                    switch(outImg.length){
                                                        ...
                                                        case 2: return(
                                                            <>
                                                                <img src={process.env.REACT_APP_SERVER_URL+outImg[0].path} alt="외관이미지" style={{width:'50%', height:'100%'}}/>
                                                                <img src={process.env.REACT_APP_SERVER_URL+outImg[1].path} alt="외관이미지" style={{width:'50%', height:'100%'}}/>
                                                            </>
                                                        );
                                                        case 3: return(
                                                            <>
                                        ...
                                        return(
                                            ...
                                            {Array.from({ length: outImg.length }).map((_, idx) => (
                                                // <div style={{width:'50%', padding:'2px'}}>
                                                    <img src={"http://192.168.240.250:8080"+outImg[idx].path} alt='외관이미지' key = {idx} style={{width:'50%', borderRadius:'8px', boxSizing:'border-box', padding:'2px'}}/>
                                                // </div>
                                            ))}
                                            </div>
                                        )
