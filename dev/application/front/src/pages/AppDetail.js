...
function ApiDocumentForm() {
    ...
    // function
    const successNotify = (e) => toast.success(e,{
        position: "top-right",
        autoClose: 3000,
                ...
                <Row>
                    ...
                    <div className="KDC_AppInfo__root__DWY2K area_appinfo">
                        ...
                        <div className="box_typeinfo">
                            <strong className="tit_typeinfo">{appOne.name}
                    ...
                    <div className="KDC_Row__root__1xlqH KDC_Row__responsive__2Leq_">
                        <div className="KDC_Column__root__1Zx1r KDC_Column__flex_1__3WFYc">
                            <div className="KDC_Section__root__2FzZg">
                                ...
                                <ul className="KDC_ListLayout__root__Sgohq">
