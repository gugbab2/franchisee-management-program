...
function Map() {
    ...
    const searchAjax = (inputkeyword) =>{
        instance({
            ...
            setSearchData({});
            toast.error('검색결과가 없습니다', toastDefaultOption);
        });
    }
    ...
    return (
        <>
            <div className="outline">
                ...
                <SearchResultList options={options1} resultTog={{ searchResultToggle, setsearchResultToggle }} searchData={{searchData,setSearchData}} detailSearchTogOpen={detailSearchTogOpen} detailTogClose={detailTogClose} keyword={keyword}/>
