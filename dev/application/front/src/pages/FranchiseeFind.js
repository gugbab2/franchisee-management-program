...
function FanchiseeNodeList({ searchData }){
    return(
        <>
            {
                (searchData == null) &&(
                        ...
                        <div className="find__list">
                            ...
                            </div>
                            {
                                searchData.franchisees.map((franchisee, idx) => {
                                    return(
                                        <FanchiseeNode franchisee={franchisee} key={idx}/>
                                    );
                                })
                            }
                        </div>
...
function FanchiseeNode({ franchisee }){

    const navigate = useNavigate();

    const goPlace = () => {
        navigate('/map',{state:franchisee});
    }
            ...
            <div className="find__node__body">
                ...
                <div className="find__node__info">
                    ...
                    <div className="find__node__tel">
                        {franchisee.tel.replace(/(\d{2})(\d{3,4})(\d{4})/,"$1-$2-$3")}
                    </div>
            ...
            <Container style={{marginTop : "109px"}}>
                {
                    !searchPage && (
                        <>
                            ...
                            <FanchiseeNodeList searchData={franchiseeList}/>
                                    ...
                                    <Form.Select disabled={!telActive} value={selValue} onChange={(e) => {setSelValue(e.target.value)}}>
                                        {
                                            ["02","031","032","033","041","042","043","044","051",
                                                "052","053","054","055","061","062","063","064"].map((localNum,idx) => {
                                                    return(
