...
import FindPWModal from "../template/FindPWModal";
...
function Login({ closeLoginModal, showFindPWModal, showRegisterModal }) {
    ...
    const userinfoEmail = (e) => {
        ...
        if (emailreg.test(e.target.value)) {
            ...
            // toast.error('이메일 형식을 맞춰주세요', toastDefaultOption);
        }
        ...
        if (emailreg.test(email)) {
            if (email && password) {
                instance({
                    ...
                    toast.success('로그인 되었습니다!', toastDefaultOption);
                }).then(function () {
                    instance({
                        method: "get",
                    ...
                    toast.error("ID,PW를 확인해주세요", toastDefaultOption);
                });
            } else {
                toast.error("ID,PW를 입력해주세요", toastDefaultOption)
            }
        } else {
            setEmailchk(true)
            setTimeout(() => {
