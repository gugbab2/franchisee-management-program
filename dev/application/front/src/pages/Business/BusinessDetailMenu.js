    ...
    return (
        <div className='businessDetailMenu'>
            <div className='businessDetailMenu--MenuInput'>
                <div>
                    <span className='businessDetailInfo--InfoInput-text' onClick={(e) => console.log(menuList)}>메뉴를 추가해주세요.</span><span className='businessDetailInfo--essential'>*필수</span>
                </div >
            </div >
            <div>
            ...
            {menuList.length > 0 ? (<>{menuList.map((ele, idx) => {
                return (
            ...
            })}</>) : (<><div className="businessDetailMenu--defaultMenuZone">
                <h1>
